...
class tl_frontendbuilder extends Backend
{
	...
	{	
		if ($args[0] !== '')
		{
			...
			if ($objFile !== null)
			{
				$args[0] = Image::getHtml(
                    System::getContainer()->get('contao.image.image_factory')->create(TL_ROOT . '/' . $objFile->path, array(100, 75, 'center_top'))->getUrl(TL_ROOT), '', 'class="theme_preview titel_elementsets"');
			}
		}
		return $args;
	}
